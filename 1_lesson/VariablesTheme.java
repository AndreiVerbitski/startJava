public class VariablesTheme {
    ...
    public static void main(String[] args) {
        ...
        int y = 200;
        int allItems = x + y;
        double amountSale = allItems * 0.11;
        double total = allItems + amountSale;

        System.out.println("Сумма скидки " + amountSale);
        ...
        System.out.println(srcNum / 100); // ravno 3
        System.out.println((srcNum / 10) % 10) ; // ravno 4
        System.out.println((srcNum % 10)); // ravno 5


        int number_1 = srcNum / 100;
        int number_2 = (srcNum / 10) % 10;
        int number_3 = (srcNum % 10);
        int sumDigits = number_1 + number_2 + number_3;
        int multDigits = number_1 * number_2 * number_3;
        System.out.println("Сумма чисел 3 4 5 = " + sumDigits);
        System.out.println("Произведение чисел 3 4 5 = " + multDigits);
        ...
        System.out.println(slash + slash + slash + slash);

        System.out.println("\n9. Отображение количества сотен, десятков и единиц числа");

        int srcNum1 = 123;

        System.out.println("Число " + srcNum1 + " содержит " + (srcNum1 / 100) + " сотен");
        System.out.println("Число " + srcNum1 + " содержит " + (srcNum1 / 10 ) + " десятков");
        System.out.println("Число " + srcNum1 + " содержит " + (srcNum1 % 10 ) + " единиц");

        System.out.println("\n10. Преобразование секунд");

        int secconds = 86399;

        int leftSec = secconds % 60;
        int minutes = secconds / 60;
        int leftMin = minutes % 60;
        int hours = secconds / 3600;

        System.out.println(hours + ":" + leftMin + ":" + leftSec);
